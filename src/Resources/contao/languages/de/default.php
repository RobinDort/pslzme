...
$GLOBALS['TL_LANG']['tl_content']['contentSpace'] = ['Container Abstand', 'Außenabstände für den Container festlegen'];
$GLOBALS['TL_LANG']['tl_content']['textSpace'] = ['Text Abstand', 'Abstand für den Text innerhalb des Bildes festlegen'];
