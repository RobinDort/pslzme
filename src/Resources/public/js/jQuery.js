...
!(function (e, t) {
				...
				if (!(h[t + " "] || (p && p.test(t)))) {
					if (((c = t), (f = e), 1 === d && (b.test(t) || m.test(t)))) {
						((f = (P.test(t) && X(e.parentNode)) || e) == e && le.scope) ||
							((s = e.getAttribute("id")) ? (s = ce.escapeSelector(s)) : e.setAttribute("id", (s = k))),
							(o = (l = Y(t)).length);
				...
				n != C &&
					...
					F(function (e) {
						...
						(r.appendChild(e).innerHTML =
							"<a id='" + k + "' href='' disabled='disabled'></a><select id='" + k + "-\r\\' disabled='disabled'><option selected=''></option></select>"),
				...
				preFilter: {
					...
					PSEUDO: function (e) {
						...
						return N.CHILD.test(e[0])
							...
							: (e[3]
									? (e[2] = e[4] || e[5] || "")
									: n && A.test(n) && (t = Y(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && ((e[0] = e[0].slice(0, t)), (e[2] = n.slice(0, t))),
							  e.slice(0, 3));
					},
				},
				filter: {
			...
			for (
				...
				if ((t = x.relative[e[s].type])) c = [K(J(c), t)];
					...
					if ((t = x.filter[e[s].type].apply(null, e[s].matches))[k]) {
						...
						return ee(
							1 < s && J(c),
							1 < s && G(e.slice(0, s - 1).concat({ value: " " === e[s - 2].type ? "*" : "" })).replace(ve, "$1"),
							t,
							s < n && te(e.slice(s, n)),
							n < r && te((e = e.slice(n))),
							n < r && G(e)
				...
				while (l--)
					(p = g = (s = De.exec(e[l]) || [])[1]),
						...
						p &&
							...
							(d = u[p]) ||
								(((d = u[p] = []).delegateCount = 0), (f.setup && !1 !== f.setup.call(t, r, h, a)) || (t.addEventListener && t.addEventListener(p, a))),
	...
	function Be(n, r, i, o) {
		...
		if (f && ((t = (e = Ae(r, n[0].ownerDocument, !1, n, o)).firstChild), 1 === e.childNodes.length && (e = t), t || o)) {
			for (s = (a = ce.map(Ee(e, "script"), Me)).length; c < f; c++)
				(u = e), c !== d && ((u = ce.clone(u, !0, !0)), s && ce.merge(a, Ee(u, "script"))), i.call(n[c], u, c);
			if (s)
	...
	function Fe(e, t, n) {
		for (var r, i = t ? ce.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
			n || 1 !== r.nodeType || ce.cleanData(Ee(r)), r.parentNode && (n && J(r) && ke(Ee(r, "script")), r.parentNode.removeChild(r));
		return e;
	}
	ce.extend({
			...
			"margin" === n && (l += ce.css(e, n + G[a], !0, i)),
				r
					...
					: ((u += ce.css(e, "padding" + G[a], !0, i)),
					  "padding" !== n ? (u += ce.css(e, "border" + G[a] + "Width", !0, i)) : (s += ce.css(e, "border" + G[a] + "Width", !0, i)));
				...
				: ("boolean" == typeof t && ((n = t), (t = !1)),
				  t ||
						(le.createHTMLDocument
							? (((r = (t = m.implementation.createHTMLDocument("")).createElement("base")).href = m.location.href), t.head.appendChild(r))
							: (t = m)),
				  (o = !n && []),
